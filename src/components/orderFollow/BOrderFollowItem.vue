<template>
  <div class="orderFollowItemClass">
      ...
      <div v-else class="orderFollowItem-normal">
        ...
        >
          ...
          <div class="row-class bOrderFollowItem-row-time">
            <img src="@/assets/images/orderFollow-up/time@3x.png" class="timeImage" />
        ...
        >
          ...
          <p v-if="followItem.add1">
            <strong>活动名称：</strong>
            {{followItem.add1}}
          </p>
          <p v-if="followItem.add2">
            <strong>预约服务名称：</strong>
            {{followItem.add2}}
          </p>
          <p v-if="followItem.add3">
            <strong>用户地址：</strong>
            {{followItem.add3}}
          </p>
        </div>
        ...
        >
          ...
          <p v-if="followItem.add6">
            <strong>用户地址：</strong>
            {{followItem.add6}}
          </p>
        </div>
        <!--其他类型（只有取消、异常状态才显示）详细信息-->
        <div v-else class="information-p" v-show="followItem.detailShow">
        ...
        <div class="bottom-class">
          ...
          >
            <img src="@/assets/images/orderFollow-up/dian@3x.png" class="dian-class" />
          </div>
          <!--估价不显示录单操作-->
    ...
    <md-popup v-model="popShow" position="center">
      <div class="popInput">
    ...
    <md-dialog :closable="false" v-model="orderDelSucDialog.open" :btns="orderDelSucDialog.btns">
    ...
    >订单{{orderDelApplyDialog.orderNo}}绑了定了相关权益，您无权删除，请填写删除理由后转至营销经理审批。</md-dialog>
  </div>
</template>
